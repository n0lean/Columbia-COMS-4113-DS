...
type MapReduce struct {
	...
	idleWorker        chan string
	finishedMapJob    chan int
	finishedReduceJob chan int
	doneMapChannel    chan bool
	doneReduceChannel chan bool
}
...
func InitMapReduce(nmap int, nreduce int,
	...
	mr.idleWorker = make(chan string)
	mr.finishedMapJob = make(chan int, nmap)
	mr.finishedReduceJob = make(chan int, nreduce)
	mr.doneMapChannel = make(chan bool)
	mr.doneReduceChannel = make(chan bool)
